...
Данные от нескольких электродов ЭЭГ передаются в микрокомпьютер STM32, где они преобразуются в числовые значения, фильтруются, объединяются в пакеты и передаются по интерфейсу RS232 в микрокомпьютер `RaspberryPi`.
...
****
### 1.2.5. Дополнительная литература <a name="125"></a>
...
## 1.4. Облачная платформа *Bluemix* <a name="14"></a>
...
## 1.5. Краткое описание концепций *Bluemix* <a name="15"></a>
...
### 1.5.1. Развертывание и управление приложением <a name="151"></a>
...
### 1.5.2. Сервисы DevOps Services для *Bluemix* <a name="152"></a>
...
### 1.5.3. Среда визуальной разработки JavaScript приложений Node-RED <a name="153"></a>
...
### 1.5.4. Терминология Node-RED <a name="154"></a>
...
### 1.5.5. Пример использования Node-RED <a name="155"></a>
