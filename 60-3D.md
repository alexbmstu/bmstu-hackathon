...
if __name__ == "__main__":
  ...
  ```
   ...
   E. Далее, запускаем `основной скрипт` записи данных с  3х каналов ЭЭГ `hackathon_final.py`
      
   F. Результат можно видеть на графике в консоли
