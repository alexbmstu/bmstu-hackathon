...
### 5.2.1 Публикация и работа с 3D-тренажером <a name="521"></a>
...
`python hackathon_R.py > /dev/null 2>&1 &`
...
if __name__ == "__main__":
  ...
  ```
   ...
   D. Далее, запускаем `основной скрипт` записи данных с  3х каналов ЭЭГ:
