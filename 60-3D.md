...
* Теперь попробуем опубликовать свое приложение.
  Заменим все директории со статикой в директории скачанного примера на свои (п.5.2 - публикация 3D-тренажера или консоли с графиками), в примере ниже папка static
